...
/// @title MockUSDC - Test ERC-20 token mimicking USDC
/// @notice Freely mintable for testnet use. 6 decimals like real USDC.
contract MockUSDC {
    ...
    /// @notice Maximum amount per faucet call (10,000 USDC)
    ...
    /// @notice Convenience faucet - mints 10,000 USDC to caller
